...
<div id="feature"> 
<label>Answer from specialist </label><input type="text" name="Answer from specialist"><br>
<label>Specialist name </label><input type="text" name="Specialist name"><br>
<label>Specialist id </label><input type="number" name="Specialist_id"><br><br>
